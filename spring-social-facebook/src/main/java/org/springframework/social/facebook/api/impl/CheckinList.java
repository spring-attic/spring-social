...
/**
 * Holder class to hold a typed list of Checkins, pulled from the "data" field of the JSON object structure.
...
class CheckinList {
	...
	@JsonCreator
	public CheckinList(@JsonProperty("data") List<Checkin> list) {
		this.list = list;
	}
