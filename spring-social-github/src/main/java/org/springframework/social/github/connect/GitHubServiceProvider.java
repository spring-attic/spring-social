...
public class GitHubServiceProvider extends AbstractOAuth2ServiceProvider<GitHubApi> {
	...
	public GitHubServiceProvider(String clientId, String clientSecret, ConnectionRepository connectionRepository) {
		super("github", connectionRepository, 
				new OAuth2Template(clientId, clientSecret, "https://github.com/login/oauth/authorize?client_id={client_id}&redirect_uri={redirect_uri}&scope={scope}", "https://github.com/login/oauth/access_token"));
	}
