...
public class GowallaServiceApiAdapterTest {

	private GowallaServiceApiAdapter apiAdapter = new GowallaServiceApiAdapter();
	
	private GowallaApi serviceApi = Mockito.mock(GowallaApi.class);
