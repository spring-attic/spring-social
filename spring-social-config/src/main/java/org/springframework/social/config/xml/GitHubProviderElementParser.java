...
public class GitHubProviderElementParser extends AbstractServiceProviderElementParser {
	...
	private static final String AUTHORIZATION_URL = "https://github.com/login/oauth/authorize?client_id={clientId}&redirect_uri={redirectUri}&scope={scope}";
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		return registerServiceProviderBean(parserContext, name, GitHubServiceProvider.class.getName(), "GitHub",
