...
public interface OAuth10Operations {
	 ...
	 */
	OAuthToken fetchNewRequestToken();
	 ...
	 * @param callbackUrl the callback URL that should be returned to after authorization.
	 ...
	 * @param requestToken an authorized request token
	 * @return an access token granted by the provider
	 */
	OAuthToken exchangeForAccessToken(OAuthToken requestToken);
